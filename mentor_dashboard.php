...
<body>
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-2 col-md-3 sidebar" id="sidebar">
                ...
                <!-- <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#myProfileModal">
                    My Profile
                </button> -->
                ...
                <div class="row mt-4">
                    <div class="col-lg-4 col-md-6 mb-3">
                        <div class="card p-3 text-white" style="background: linear-gradient(135deg, #8e44ad, #3498db);">
                            <div class="card-body">
                                <h5 class="card-title">Hackathon Prize</h5>
                                <h2>Rs. 15,000/-</h2>
                    ...
                    <div class="col-lg-4 col-md-6 mb-3">
                        <div class="card p-3 text-white" style="background: linear-gradient(135deg, #2980b9, #27ae60);">
                            <div class="card-body">
                                <h5 class="card-title">Total Problem Statement</h5>
                                <h2>9</h2>
                                <p class="card-subtitle"></p>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 mb-3">
                        <div class="card p-3 text-white" style="background: linear-gradient(135deg, #e74c3c, #f39c12);">
                            <div class="card-body">
                                <h5 class="card-title">Hackathon Date</h5>
                                <h2>25th December 2024</h2>
                                <p class="card-subtitle"></p>
                            </div>
                        </div>
                    </div>
                        ...
                        <form id="profilePicForm" method="POST" enctype="multipart/form-data" action="changeProfilePic.php">
                            <div class="text-center mb-4">
                                <div class="position-relative d-inline-block">
                                    <img src="<?php echo $imagePath; ?>" id="profilePic" class="rounded-circle" alt="Profile Picture" width="100">
    ...
    <script>
        // When the form is submitted, hide the form modal and show the OTP modal
    ...
    <script>
        // Show "Change" icon on hover
        const profilePic = document.getElementById('profilePic');
        const changePicHover = document.getElementById('changePicHover');
        const changePicInput = document.getElementById('changePicInput');

        profilePic.addEventListener('mouseenter', function() {
            changePicHover.style.display = 'block';
        });

        profilePic.addEventListener('mouseleave', function() {
            changePicHover.style.display = 'none';
        });

        changePicHover.addEventListener('mouseenter', function() {
            changePicHover.style.display = 'block';
        })

        changePicHover.addEventListener('click', function() {
            changePicInput.click();
        });

        // Handle file input change for profile picture
        changePicInput.addEventListener('change', function() {
            const file = changePicInput.files[0];
            if (file) {
