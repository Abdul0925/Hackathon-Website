        ...
        <div class="main">
            ...
            <div class="report-container">
                ...
                <div class="report-body">
                    <!-- top hedding -->
                    <div class="lerder-details">
                        <h3>Leader Details:</h3>
                        <label><b>Name: </b> <?php echo $leader['leaderName'] ?></label>
                        <label><b>Email: </b><?php echo $leader['leaderEmail'] ?></label>
                        <label><b>Mobile: </b><?php echo $leader['leaderMobile'] ?></label>
                        <label><b>Gender: </b><?php echo $leader['leaderGender'] ?></label>
                        <label><b>PS Choosen: </b><?php echo $leader['psId'] ?></label>
                    </div>
                    <?php if ($isIdeaAvailable) { ?>
                        <div class="idea-details">
                            <h3>Idea Details:</h3>
                            <label><b>Title: </b><?php echo $idea['psTitle'] ?></label>
